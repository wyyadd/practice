...
void MainWindow::on_pushButton_clicked(){
    ...
    ImageAddress = QFileDialog::getOpenFileName
            (this,tr("Open Image"), "/home/wyyadd/Pictures", tr("Image Files (*.bmp *.BMP)"));
...
void MainWindow::on_pushButton_7_clicked(){
    ...
    if(image != nullptr)
        delete image;
    ImageAddress = QFileDialog::getOpenFileName
            (this,tr("Open Image"), "/home/wyyadd/Pictures", tr("Image Files (*.raw)"));
    if(!ImageAddress.isNull()){
...
void MainWindow::on_pushButton_8_clicked(){
    ...
    if(image->type == "bmp"){
        QMessageBox::information(NULL, "失败", "非raw图像", QMessageBox::Yes);
        return;
    }
